...
armajump.sim = function(n_obs, c, ar1, ar2, ar3, std, jump_prob)
{
...
{
  data = armajump.sim(n_obs, c, ar1, ar2, ar3, std, jump_prob)
...
for (n_obs in n_obs_list) {
  ...
  write_rds(this_pbloss, paste0("../results/PBLOSS_ARMAJUMP3_",n_obs,"obs.rds"))
  write_rds(this_pbloss, paste0("../results/CDELOSS_ARMAJUMP3_",n_obs,"obs.rds"))
  
  processed_loss = process_loss_outputs(this_pbloss,this_cdeloss)
  write_rds(processed_loss,paste0("../results/processed/ARMAJUMP3_",n_obs,"obs.rds"))
